...
const Home = () => {
  ...
  const artists = ["artist1.png", "artist2.png", "artist3.png", "artist4.png",
                  "artist5.png", "artist6.png", "artist7.png", "artist8.png"];
  const collections = ["collection1.png", "collection2.png", "collection3.png", "collection4.png"];
  ...
  const faqs = [
    ...
    "How Nonfiggybles work?",
    "How can i connect a wallet with Nonfiggybles?",
  ...
  const renderTitleContent = () => {
    return (
      <Flex
          ...
          position="relative"
      >
        <Box position="absolute" w="calc(100% - 10px)" zIndex={0} color="#8734DD">
          <Particles
            params={{
              "particles": {
                  "number": {
        ...
        >
          <Flex flexDirection="column" p="8rem 0">
            <Text fontFamily="PressStart2PRegular" fontSize="60px" textAlign="center" color="#9E00FF">
              NON FIGGYBLE
            </Text>
            <Text fontFamily="PressStart2PRegular" fontSize="60px" textAlign="center" color="#9E00FF">
              NFT MARKETPLACE
            ...
            <Flex flexDirection="row" justifyContent="center" mt="2rem">
              <Flex border="1px solid #942DFE" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer" mr="2rem">
                <Text fontWeight="500" fontSize="16px">Explore us</Text>
              </Flex>
              <Flex border="1px solid #942DFE" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer">
                <Text fontWeight="500" fontSize="16px">Create</Text>
              </Flex>
            </Flex>
          </Flex>
        </Flex>
        ...
        >
          <Flex flexDirection="column" p="3rem 0">
            ...
            <Box w="100%" h="1px" bg="#4d4456" mb="3rem">
              <Box w="10%" h="3px" bg="#942DFE" borderRadius="3px" mt="-1px"></Box>
            </Box>
                  ...
                  return (
                    <Box key={key}>
                      <Flex flexDirection="column" position="relative">
                        ...
                        <Text position="absolute" bottom="3.5rem" left="1rem" fontWeight="600">Take My Muffin</Text>
                        <Text position="absolute" bottom="2rem" left="1rem" fontSize="12px" color="#716B78">ERC - 123</Text>
                      </Flex>
                    </Box>
                  )
                })}
      ...
      >
        ...
        >
          <Flex flexDirection="column" p="3rem 0">
            ...
            <Box w="100%" h="1px" bg="#4d4456" mb="3rem">
              <Box w="5%" h="3px" bg="#942DFE" borderRadius="3px" mt="-1px"></Box>
            </Box>
                ...
                {artists.map((item, key) => {
                  return (
                    <Flex key={key} flexDirection="row">
                      <Flex flexDirection="column" position="relative">
                        <Image src={"/images/homepage/" + item}/>
                        <Image src="/images/homepage/check.svg" w="1rem" position="absolute" right="-0.4rem" top="55%"/>
                      </Flex>
                      <Flex flexDirection="column" m="auto 0 auto 1rem">
                        <Text fontWeight="600">Take My Muffin</Text>
                        <Text fontSize="14px" color="#716B78">10 ETH</Text>
                      </Flex>
                    </Flex>
                  )
                })}
        ...
        >
          <Flex flexDirection="row" w="100%">
            <Flex w="2.5rem" m="auto 1rem auto 0">
              <Flex w="2.5rem" h="2.5rem" border="1px solid #C2C8D6" borderRadius="100%" cursor="pointer" mt="3rem">
                    ...
                    return (
                      <Box key={key}>
                        ...
                        <Flex flexDirection="row" mt="1rem">
                          <Flex flexDirection="column" position="relative" m="auto 0">
                            <Image src={"/images/homepage/artist.png"} w="2rem" h="2rem"/>
                            <Image src="/images/homepage/check.svg" w="0.6rem" position="absolute" right="-0.2rem" top="35%"/>
                          </Flex>
                          <Flex flexDirection="column" ml="1rem">
                            <Text fontWeight="600">Take My Muffin</Text>
                            <Text fontSize="12px" color="#716B78">ERC - 123</Text>
                          </Flex>
                        </Flex>
                      </Box>
                    )
            ...
            <Flex w="2.5rem" m="auto 0 auto 1rem">
              <Flex w="2.5rem" h="2.5rem" bg="#942DFE" borderRadius="100%" cursor="pointer" mt="3rem">
        ...
        >
          <Flex flexDirection="column" p="3rem 0">
            ...
            <Flex flexDirection="row" justifyContent="center">
              <Flex border="1px solid #4D4456" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer" mr="1rem">
                <Text fontWeight="500" fontSize="16px">Art</Text>
              </Flex>
              <Flex border="1px solid #4D4456" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer" mr="1rem">
                <Text fontWeight="500" fontSize="16px">Photography</Text>
              </Flex>
              <Flex border="1px solid #4D4456" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer" mr="1rem">
                <Text fontWeight="500" fontSize="16px">Games</Text>
              </Flex>
              <Flex border="1px solid #4D4456" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer" mr="1rem">
                <Text fontWeight="500" fontSize="16px">Music</Text>
              </Flex>
              <Flex border="1px solid #4D4456" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer" mr="1rem">
                <Text fontWeight="500" fontSize="16px">Defi</Text>
              </Flex>
              <Flex bg="#651AB2" borderRadius="30px" p=" 0.5rem 1.5rem" cursor="pointer" mr="1rem">
                <Text fontWeight="500" fontSize="16px">All</Text>
              </Flex>
            </Flex>
            ...
            <Flex m="3rem 0 5rem 0">
              <Flex bg="#651AB2" borderRadius="30px" p="0.5rem 3rem" cursor="pointer" m="0 auto">
                <Text fontWeight="500" fontSize="16px">View more</Text>
              </Flex>
            </Flex>
          </Flex>
        </Flex>
      ...
      <Box position="absolute" w="calc(100% - 10px)" zIndex={0} color="#8734DD">
        ...
        >
          <Box w="45%">
            ...
            <Box w="100%" h="1px" bg="#4d4456" mb="3rem">
              <Box w="15%" h="3px" bg="#942DFE" borderRadius="3px" mt="-1px"></Box>
            </Box>
            {faqs.map((item, index) => {
              return (
                <Box mb="1rem" key={index}>
                  <Flex flexDirection="row" p="1rem 1.5rem" bg="#26212A">
                    <Flex p="0.5rem" bg="#942DFE" cursor="pointer" maxH="31px" m="auto 0">
                      <Image src="/images/homepage/plus.svg"/>
                    </Flex>
                    <Text m="auto 0 auto 1.5rem" fontSize="18px" fontWeight="600">{item}</Text>
                  </Flex>
                  {index === 0 && 
                    <Flex flexDirection="row" p="1rem 1.5rem" bg="#26212A" mt="1rem">
                      <Text fontSize="16px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.</Text>
                    </Flex>
                  }
                </Box>
              )
