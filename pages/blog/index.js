...
const Blog = () => {
              ...
              <HStack spacing={9} align w="50rem" key={currNumber}>
                ...
                <VStack spacing={6} align>
                  ...
                  <Text fontSize="25px" fontWeight="700">
                    EXAMPLE OF A RANDOM TITLE FOR THE BLOG POST TO INDICATE THE
                    LAYOUT OF THIS ELEMENT. + {currNumber}
                  </Text>
                  <Button
  ...
  //To be deleted
  const monthsForManyAccordionItems = [
    "May 2021",
    "April 2021",
    "March 2021",
    "February 2021",
      ...
      <Flex flexDir="column" w="30rem">
        ...
        <Accordion defaultIndex={[]} allowMultiple overflow="visible">
          {months.map((month) => {
            return (
              <AccordionItem
                borderBottom=" 1px dashed #4D4456"
                borderTop="none"
                w="50%"
                key={month}
              >
                ...
                <AccordionPanel>
                  This will be different for each month; must receive data to
                  display accordingly.
                </AccordionPanel>
              </AccordionItem>
            );
    ...
    return (
      <Flex flexDir="column" w="30rem">
        ...
        <HStack spacing={10} justify="center">
          <a href="https://discord.gg/H3ZyRqkZ84" target="_blank">
            {" "}
            <Icon
              as={SiDiscord}
              boxSize="3rem"
          ...
          <a href="https://twitter.com/figgybles" target="_blank">
            <Icon
          ...
          <a href="https://www.instagram.com/nonfiggybles/" target="_blank">
            {" "}
            <Icon
              as={FiInstagram}
              boxSize="3rem"
          ...
          <a href="https://nonfiggybles.medium.com/" target="_blank">
            <Icon
